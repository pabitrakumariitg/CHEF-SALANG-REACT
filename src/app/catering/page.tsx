    ...
    <div className="pt-24">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image 
            src="https://images.unsplash.com/photo-1532117892888-38948e152b3a?q=80&w=2940&auto=format&fit=crop" 
      ...
      <section className="section-padding bg-card">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Wedding */}
            <div className="bg-background p-8 rounded-lg card-hover">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              <div className="bg-background rounded-lg p-8">
                ...
                <p className="text-muted-foreground">
                  Chef Salang and his team handle all aspects of food preparation, service, and cleanup, ensuring a seamless experience.
                </p>
              </div>
            </div>
          </div>
